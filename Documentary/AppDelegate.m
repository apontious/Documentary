...
@property (nonatomic) iCloudManager *iCloudManager;
@property (nonatomic) NSURL *ubiquityContainerURL;
@property (nonatomic) NSMetadataQuery *query;

@end

NSString *const kDidCreateFirstDocumentKey = @"didCreateFirstDocument";

@implementation AppDelegate

- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    
    self.window.tintColor = [UIColor colorWithRed:0.87 green:0 blue:0.87 alpha:1];
